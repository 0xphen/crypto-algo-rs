...
pub mod init_hash {
    ...
    mod tests {
        ...
        fn initialize_h_0() {
            ...
            let parsed_hash = init_hash(constants::H_0);
            assert_eq!(parsed_hash, expected_h_0_padded_msg);
        }
    }
}

// 6a09e667
// 
